...
class MyData_tr(Dataset):
	...
	def __getitem__(self,index):
		...
		img = transforms.ToTensor()(Image.fromarray(cv2.imread(os.path.join(self.image_path,self.image_list[index]))))
		overlap = transforms.ToTensor()(Image.fromarray(cv2.imread(os.path.join(self.overlap_path,self.image_list[index]))))
		gradient  = overlap
