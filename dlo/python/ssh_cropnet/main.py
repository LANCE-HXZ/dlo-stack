...
def test(**kwargs):
    ...
    if total_label/4 >= 50:
        print(1, total_label/4, total_probability/400, total_label/4-total_probability/400)
    else:
        print(0, 100-total_label/4, 100-total_probability/400, (100-total_label/4)-(total_probability/400))
    # return results
