...
class image_converter:
  ...
  def __init__(self):
    self.class_list_pub = rospy.Publisher("crop_class_topic", std_msgs.msg.Int64, queue_size=1000)
    self.bridge = CvBridge()
    self.image_sub = rospy.Subscriber("/camera/color/image_raw", sensor_msgs.msg.Image, self.rgb_callback)
