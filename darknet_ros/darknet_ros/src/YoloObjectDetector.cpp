...
void YoloObjectDetector::init()
{
  ...
  nodeHandle_.param("yolo_model/weight_file/name", weightsModel,
                    std::string("yolov3-voc_final.weights"));
  nodeHandle_.param("weights_path", weightsPath, std::string("/home/lance/Workspaces/hxz_ws/src/darknet_ros/darknet_ros/yolo_network_config/weights"));
  ...
  // Path to config file.
  nodeHandle_.param("yolo_model/config_file/name", configModel, std::string("yolov3-voc.cfg"));
  nodeHandle_.param("config_path", configPath, std::string("/home/lance/Workspaces/hxz_ws/src/darknet_ros/darknet_ros/yolo_network_config/cfg"));
  ...
  dataPath += "/home/lance/Workspaces/hxz_ws/src/darknet_ros/darknet/data";
