...
class MoveItIkDemo:
    def __init__(self):
        ...
        KUKA.set_max_acceleration_scaling_factor(0.05)
        KUKA.set_max_velocity_scaling_factor(0.05) 	
        ...
        L_target_pose.pose.position.x = 0.3
        L_target_pose.pose.position.y = 0.3
        L_target_pose.pose.position.z = 0.3
        L_target_pose.pose.orientation.x = -0.33993
        L_target_pose.pose.orientation.y = 0.631983
        L_target_pose.pose.orientation.z = 0.343667
        L_target_pose.pose.orientation.w = 0.605754
        
        R_target_pose.pose.position.x = -0.4
        R_target_pose.pose.position.y = 0.1
        R_target_pose.pose.position.z = 0.5
        R_target_pose.pose.orientation.x = 0
        R_target_pose.pose.orientation.y = 0
        R_target_pose.pose.orientation.z = 0
        R_target_pose.pose.orientation.w = 1
        ...
        R_target_pose.pose.position.x -= 0.1
        KUKA.set_start_state_to_current_state()
        KUKA.set_pose_target(L_target_pose, L_end_effector_link)
        KUKA.set_pose_target(R_target_pose, R_end_effector_link)
        traj = KUKA.plan()
        ...
        L_target_pose.pose.position.x += 0.1
        R_target_pose.pose.position.y += 0.1
        KUKA.set_start_state_to_current_state()
        KUKA.set_pose_target(L_target_pose, L_end_effector_link)
        KUKA.set_pose_target(R_target_pose, R_end_effector_link)
        ...
        L_target_pose.pose.position.z += 0.1
        R_target_pose.pose.position.z += 0.1
        KUKA.set_start_state_to_current_state()
        KUKA.set_pose_target(L_target_pose, L_end_effector_link)
        KUKA.set_pose_target(R_target_pose, R_end_effector_link)
        traj = KUKA.plan()
