...
class MoveItIkDemo:
    def __init__(self):
        ...
        L_target_pose.pose.position.x = 0.2
        L_target_pose.pose.position.y = 0
        L_target_pose.pose.position.z = 0.73
        L_target_pose.pose.orientation.x = -0.572507
        L_target_pose.pose.orientation.y = -0.0213573
        L_target_pose.pose.orientation.z = 0.819444
        L_target_pose.pose.orientation.w = -0.0170479

        R_target_pose.pose.position.x = -0.419211
        R_target_pose.pose.position.y = -0.259345
        R_target_pose.pose.position.z = -0.236716
        R_target_pose.pose.orientation.x = -0.352429
        R_target_pose.pose.orientation.y = -0.610272
        R_target_pose.pose.orientation.z = -0.332508
        R_target_pose.pose.orientation.w = 0.626738
